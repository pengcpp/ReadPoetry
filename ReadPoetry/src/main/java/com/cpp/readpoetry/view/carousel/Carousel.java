...
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
    ...
    /**
     * Default min/max quantity of item
     */
     ...
     */
    private boolean mShouldCallbackOnUnselectedItemClick = false;
    ...
    private boolean mCouldFling = false;

    /**
     * Note by Three.
     * <p/>
     * Carousel跟随手转动的速率，默认为1时候非常快...
     * Scroll时手移动的距离/Rate
     */
    private int trackMotionScrollRate = 3;
    ...
    public Carousel(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAnimationDuration = arr.getInteger(R.styleable.Carousel_android_animationDuration, 1500);
 ...
 /*       CardAdapter adapter = new CardAdapter(getContext());
        setAdapter(adapter);
        adapter.setViews(TestData.initCarouselData());
     ...
     * @param arrayList
     */
    public void setData(ArrayList<CarouselItemData> arrayList) {
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_DPAD_CENTER:
            case KeyEvent.KEYCODE_ENTER: {
                LogUtils.logInfo(TAG, "onKeyUp ->" + keyCode);
...
//        float centerX = (float) getWidth() / 2, centerY = (float) getHeight();
...
//        matrix.postTranslate(centerX, centerY);
    ...
    private class FlingRotateRunnable implements Runnable {
        ...
        /**
         * note by Three.
         * control if could start scrolling based on a fling gesture
         *
    ...
    /**
     * View adapter class for the Carousel
     */
    private class CardAdapter extends BaseAdapter {

        private Context mContext;
        private CarouselItem[] mViews;
        ...
        public void setViews(ArrayList<CarouselItemData> arrayList) {

            if (arrayList == null)
                throw new RuntimeException("Views arrays length doesn't match");

            mViews = new CarouselItem[arrayList.size()];

            for (int i = 0; i < arrayList.size(); i++) {
                final CarouselItemData itemData = arrayList.get(i);
    ...
    public boolean onDown(MotionEvent e) {
        ...
        Log.v(TAG, "onDown mDownTouchPosition " + mDownTouchPosition);
        Log.v(TAG, "onDown mSelectedPosition " + mSelectedPosition);
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        if (localLOGV) Log.v(TAG, "onFling: " + String.valueOf(e2.getX() - e1.getX()));
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
        ...
        if (localLOGV) Log.v(TAG, "onScroll: " + String.valueOf(e2.getX() - e1.getX()));
        ...
        // Track the motion
        distanceX = distanceX / trackMotionScrollRate;
...
//        invalidate();
     ...
     * @param index       X-coordinate indicating where this view should be placed. This
    ...
    private void setUpChild(CarouselItem child, int index, float angleOffset) {
        ...
        // Position vertically based on gravity setting TODO
