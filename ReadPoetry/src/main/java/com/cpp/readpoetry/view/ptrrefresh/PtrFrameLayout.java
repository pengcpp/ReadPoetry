 ...
 * you can contain everything you want.support:
 * pull to refresh / release to refresh / auto refresh / keep header view while refreshing /
 * hide header view while refreshing
 * <p/>
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private boolean mPreventForHorizontal = true;
...
//                LogUtils.logInfo("PtrFrameLayout", "ACTION_MOVE: " + Math.abs(offsetY));
