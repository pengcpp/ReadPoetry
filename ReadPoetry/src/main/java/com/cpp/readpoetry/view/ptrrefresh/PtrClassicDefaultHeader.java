...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mRotateView = header.findViewById(R.id.xlistview_header_arrow);

        mTitleTextView = (TextView) header.findViewById(R.id.xlistview_header_hint_textview);
        mLastUpdateTextView = (TextView) header.findViewById(R.id.xlistview_header_time);
        mProgressBar = header.findViewById(R.id.xlistview_header_progressbar);
...
//        mProgressBar.setVisibility(INVISIBLE);
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.xlistview_header_hint_normal));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.xlistview_header_hint_ready));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setText(R.string.xlistview_header_hint_loading);
...
//        mProgressBar.setVisibility(INVISIBLE);
        ...
        mTitleTextView.setVisibility(INVISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.xlistview_header_hint_loading_finish));
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.xlistview_header_hint_ready);
        }
    }
