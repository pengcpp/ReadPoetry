package com.cpp.readpoetry.view.gridpassword;
...
public class GridPasswordView extends LinearLayout implements GridPasswordInterface {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.textSize = DisplayUtil.px2sp(context, textSize);
        }

        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth, DisplayUtil.dp2px(getContext(), 1));
