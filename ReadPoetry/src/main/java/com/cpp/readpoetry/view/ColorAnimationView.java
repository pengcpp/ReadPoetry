...
public class ColorAnimationView extends View
    ...
    private static int[] defaultColor = TestData.ANIMATION_COLORS_7;
    ...
    public void setViewPager(ViewPager mViewPager, int pagerChildCount, int... colors) {

        if (mViewPager.getAdapter() == null) {
            throw new IllegalStateException(
                    "ViewPager does not have adapter instance.");
        }
        mPageChangeListener.setViewPagerChildCount(pagerChildCount);
    ...
    private void createDefaultAnimation() {
        colorAnim = ObjectAnimator.ofInt(this, "backgroundColor", defaultColor);
        colorAnim.setEvaluator(new ArgbEvaluator());
        colorAnim.setDuration(DURATION);
        colorAnim.addUpdateListener(this);
    }
